          ...
          >
            <div className="relative rounded-2xl overflow-hidden border border-light-border dark:border-dark-border shadow-2xl bg-light-card dark:bg-dark-card">
              ...
              <div className="p-6 lg:p-8">
                ...
                <div className="h-40 rounded-xl bg-gradient-to-br from-primary-500/5 via-secondary-500/5 to-accent-500/5 flex items-center justify-center border border-light-border dark:border-dark-border">
                  <BarChart3 size={48} className="text-secondary-500/50" />
                </div>
              </div>
            </div>
          </motion.div>
